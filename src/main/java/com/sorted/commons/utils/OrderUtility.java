...
public class OrderUtility {
    ...
    public Order_Details validateAndCreateOrder(PayNowBean req, UsersBean usersBean) throws JsonProcessingException {
        ...
        List<Order_Item> orderItems = createOrderItems(cartBean.getCartItems(), usersBean.getId());
    ...
    private List<Order_Item> createOrderItems(List<CartItems> cartItems, String userId) {
